> This page location: Neon platform > Monitoring & observability > System operations
...
| `Apply storage config` | Applies a new configuration to a Neon storage object or resource. For example, updating the [history window](https://neon.com/docs/introduction/history-window) for a project initiates this operation.                                                                                                                                                          |

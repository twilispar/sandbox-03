> This page location: Neon platform > Access & collaboration > Organizations > Transfer projects
...
**Note:** Transferring a project does not affect its credentials or connection string. Your connected applications will continue to work without any disruption.
...
![transfer multiple projects from org settings](https://neon.com/docs/manage/transfer_multiple.png)

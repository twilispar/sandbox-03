> This page location: Neon platform > Access & collaboration > Organizations > Manage Organizations
...
![organization members](https://neon.com/docs/manage/orgs_members_kebab.png "no-border")
...
See [Manage your Neon account](https://neon.com/docs/manage/accounts#two-factor-authentication) for personal 2FA setup steps.
...
- **Remove from project**: All members can revoke the Collaborator's access to the shared project.
  ...
  ![collaborators more options menu](https://neon.com/docs/manage/orgs_collaborators_kebab.png "no-border")
...
![organization settings](https://neon.com/docs/manage/orgs_id.png "no-border")

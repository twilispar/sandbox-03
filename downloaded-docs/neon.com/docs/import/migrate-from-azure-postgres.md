> This page location: Migrate to Neon > Migrate from > Azure
...
**Important:** Avoid using `pg_dump` over a [pooled connection string](https://neon.com/docs/reference/glossary#pooled-connection-string). Use an [unpooled connection string](https://neon.com/docs/reference/glossary#unpooled-connection-string) when you run `pg_dump` or `pg_restore` against Neon.

...
> Summary: Covers the mission and features of Neon, the backend for apps and agents, built on a fully managed serverless Postgres engine with managed authentication, an HTTP Data API, and a foundational separation of storage and compute.

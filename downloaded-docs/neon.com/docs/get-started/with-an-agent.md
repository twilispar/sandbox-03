...
Run this from your project root so the skills are installed in the right place. For details and manual setup, see the [`neon init` reference](https://neon.com/docs/reference/cli-init).
...
- [`neon init` reference](https://neon.com/docs/reference/cli-init)

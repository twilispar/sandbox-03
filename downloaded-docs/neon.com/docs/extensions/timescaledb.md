> This page location: Extensions > timescaledb
...
**Version availability:** For version availability, refer to our [Postgres extensions](https://neon.com/docs/extensions/pg-extensions) page, which includes a table of supported extension versions by Postgres version.

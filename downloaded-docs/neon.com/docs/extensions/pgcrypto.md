> This page location: Extensions > pgcrypto
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Covers the setup and usage of the `pgcrypto` extension in Neon, detailing how to enable it and use its cryptographic functions for encryption, decryption, and hashing within Postgres.

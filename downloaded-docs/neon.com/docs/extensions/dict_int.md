> This page location: Extensions > dict_int
...
**Important: Modifying the default intdict dictionary on Neon**
...
**Important: Modifying default text search configurations on Neon**

> This page location: Extensions > uuid-ossp
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Covers the setup of the `uuid-ossp` extension in Postgres on Neon, detailing how to enable it and use various functions for generating different types of UUIDs for unique data identification.
...
- `uuid_generate_v1()`:
  ...
  **Important: Privacy and Security Considerations for Version 1 UUIDs**
...
- `uuid_generate_v5(namespace uuid, name text)`:
  ...
  **Tip: Version 3 vs. Version 5 UUIDs**

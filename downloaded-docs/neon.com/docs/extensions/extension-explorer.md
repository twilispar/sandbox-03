...
- [plv8](https://neon.com/docs/extensions/plv8): Deprecated on Neon. Was a Postgres procedural language powered by V8 for JavaScript callable from SQL; use plpgsql or app-side logic instead

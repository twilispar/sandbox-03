> This page location: Extensions > pg_search
...
**Warning: Neon's support for pg_search has been deprecated.**
...
- **Semantic/vector search**: [`pgvector`](https://neon.com/docs/extensions/pgvector) for embedding-based search
...
**Note: pg_search on Neon**

`pg_search` is currently only available on Neon projects created in an [AWS region](https://neon.com/docs/introduction/regions#aws-regions). It is not yet supported on Neon projects created in Azure regions.

> This page location: Postgres guides > Optimize queries
...
To enable querying local file cache statistics, Neon provides a [neon_stat_file_cache](https://neon.com/docs/extensions/neon#the-neonstatfilecache-view) view. To access this view, you need to install the [neon](https://neon.com/docs/extensions/neon) extension:
...
To increase available memory for a Postgres instance in Neon, you can increase the size of your compute. Larger computes have larger local file caches. For information about selecting an appropriate compute size in Neon, refer to [How to size your compute](https://neon.com/docs/manage/computes#how-to-size-your-compute).

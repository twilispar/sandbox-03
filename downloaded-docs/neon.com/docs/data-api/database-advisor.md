> This page location: Backend > Data API > Guides > Data API Advisors
...
| [Neon Auth users exposed](https://neon.com/docs/data-api/database-advisor#neon-auth-users-exposed)                     | ERROR    | Views exposing `neon_auth.user` data to API roles                                    |
| [RLS references Neon Auth metadata](https://neon.com/docs/data-api/database-advisor#rls-references-neon-auth-metadata) | ERROR    | RLS policies referencing user-editable Neon Auth fields                              |
| [FK to Neon Auth unique constraint](https://neon.com/docs/data-api/database-advisor#fk-to-neon-auth-unique-constraint) | ERROR    | Foreign keys referencing Neon Auth unique constraints instead of primary keys        |
...
See [Neon Auth overview](https://neon.com/docs/auth/overview) and [Data API access control](https://neon.com/docs/data-api/access-control) for background.
...
See [Neon Auth overview](https://neon.com/docs/auth/overview).

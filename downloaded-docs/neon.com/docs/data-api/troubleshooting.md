> This page location: Backend > Data API > Using the Data API > Troubleshooting
...
For step-by-step instructions, see [Testing with Neon Auth](https://neon.com/docs/data-api/get-started#testing-with-neon-auth).
...
To get a JWT token for testing, see [Testing with Neon Auth](https://neon.com/docs/data-api/get-started#testing-with-neon-auth).

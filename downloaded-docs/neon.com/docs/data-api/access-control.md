> This page location: Backend > Data API > Guides > Access control & security
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Covers the authentication process of the Neon Data API, detailing how it uses PostgreSQL's security model to enforce role privileges and Row-Level Security for database access control.
...
- The `GRANT` statements would be similar to the grants for the `authenticated` role. See [Configure schema access](https://neon.com/docs/data-api/get-started#3-configure-schema-access) for an example.

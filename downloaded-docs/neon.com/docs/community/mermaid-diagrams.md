> This page location: Community > Using Mermaid diagrams
...
Guide for creating visual diagrams in Neon documentation
...
**Note:** **Keep diagrams simple**: Mermaid diagrams are constrained to a maximum width of 800px for readability. Keep your diagrams focused with 5-10 nodes maximum. For complex workflows, consider breaking them into multiple simpler diagrams.
...
- **[Component Guide](https://neon.com/docs/community/component-guide)** - Other custom components available
- **[Contribution Guide](https://neon.com/docs/community/contribution-guide)** - General documentation guidelines

> This page location: Community > Using docs as Markdown (LLMs)
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Describes how to request Neon documentation as Markdown (including for LLMs), how to discover content via the llms.txt index, how it's generated, and what we add to each page.

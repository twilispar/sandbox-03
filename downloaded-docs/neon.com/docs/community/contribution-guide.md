> This page location: Community > Docs contribution guide
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Covers the guidelines for contributing to the Neon documentation, including how to edit files on GitHub, submit pull requests, and use templates for creating new guides.
...
```md
![Neon architecture diagram](https://neon.com/docs/introduction/neon_architecture.png)
```

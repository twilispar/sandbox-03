> This page location: AI > AI for Agents > Agent Skills > Codex plugin
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Covers the Neon Postgres Codex plugin: Serverless Postgres project and database management, MCP, neon-postgres guidance, and the egress optimizer skill.
...
That flow can set up OAuth, API keys, MCP configuration, and project-level skills where applicable. See the [`neonctl init` reference](https://neon.com/docs/reference/cli-init) for details.

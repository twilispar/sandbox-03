> This page location: AI > AI App Starter Kit > AI frameworks > Inngest
...
![Inngest integrates with Neon Postgres to trigger AI workflows based on database changes](https://neon.com/docs/guides/inngest.jpg)

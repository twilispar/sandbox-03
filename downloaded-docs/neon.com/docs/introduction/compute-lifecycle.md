> This page location: Architecture > Compute lifecycle
...
![Scale to zero configuration dialog](https://neon.com/docs/introduction/autoscaling_config.png)
...
![Compute state](https://neon.com/docs/introduction/compute_state.png)

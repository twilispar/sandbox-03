> This page location: Plans and billing > Agent plan
...
Learn about using Neon to provision and manage databases for agentic platforms
...
- [Integrating with Neon](https://neon.com/docs/guides/platform-integration-overview)
...
Once your application is approved, the Neon team switches your Scale account to the Agent Plan and helps you set up a second Free Account for your Free Tier if needed. After setup, you manage all projects and configurations independently via the [Neon API](https://neon.com/docs/reference/api-reference).

> **Neon agent plan**
>
> For custom rate limits and dedicated support for your agent platform, apply now.
>
> [Apply](https://neon.com/use-cases/ai-agents)
...
After initial enrollment, you have full control over both organizations as admin. Each organization supports 30,000 projects by default. All project operations are performed through the [Neon API](https://neon.com/docs/reference/api-reference), enabling fleet management at scale with small engineering teams. You can:
...
With the sponsored free and paid organization structure of the agent plan, you can move user projects between organizations when they upgrade or downgrade tiers. Transferring projects between organizations requires a [personal API key](https://neon.com/docs/manage/api-keys#types-of-api-keys) with access to both organizations. You can transfer up to 400 projects per request.
...
For step-by-step implementation instructions, see the [AI Agent integration guide](https://neon.com/docs/guides/ai-agent-integration).

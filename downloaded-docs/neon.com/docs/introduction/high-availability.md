> This page location: High availability
...
![Neon architecture diagram](https://neon.com/docs/introduction/neon_architecture_5.jpg)
...
![HA storage failover](https://neon.com/docs/introduction/HA-storage-failover.png)
...
![Postgres restarting after failure](https://neon.com/docs/introduction/postgres_fails.png)
...
![VM restarting after failure](https://neon.com/docs/introduction/vm_fails.png)

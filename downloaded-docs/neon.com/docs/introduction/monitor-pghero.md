> This page location: Neon platform > Monitoring & observability > Third-party monitoring > PgHero
...
![PgHero Dashboard](https://neon.com/docs/introduction/pg_hero.png)
...
Then visit [http://localhost:8080](http://localhost:8080) in your browser to open the PgHero Dashboard.

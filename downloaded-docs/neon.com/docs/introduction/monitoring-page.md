> This page location: Neon platform > Monitoring & observability > Monitoring dashboard
...
**Note: Endpoint Inactive: What does it mean?**
...
![monitoring graph diagonal pattern for inactive compute](https://neon.com/docs/introduction/monitor_inactive.png)

## RAM

![Monitoring page RAM graph](https://neon.com/docs/introduction/monitor_ram.png)
...
![Monitoring page CPU graph](https://neon.com/docs/introduction/monitor_cpu.png)
...
**Note:** If you're using [connection pooling](https://neon.com/docs/connect/connection-pooling), also monitor the [Pooler client connections](https://neon.com/docs/introduction/monitoring-page#pooler-client-connections) and [Pooler server connections](https://neon.com/docs/introduction/monitoring-page#pooler-server-connections) graphs. When using a pooled connection, the **Pooler server connections** represent the actual connections from PgBouncer to Postgres, while this **Postgres connections count** graph shows all direct connections to Postgres (including those from the pooler and any direct connections).

## Pooler client connections

![Pooler client connections graph](https://neon.com/docs/introduction/pooler_client_connections.png)

The **Pooler client connections** graph shows connections from your applications to Neon's PgBouncer connection pooler. This graph only displays data when you're using a [pooled connection string](https://neon.com/docs/connect/connection-pooling) (one that includes `-pooler` in the endpoint hostname).
...
**Tip:** Connection pooling works by allowing many client connections to share a smaller pool of actual Postgres connections. While you can have thousands of client connections, they share a limited number of server connections determined by PgBouncer's `default_pool_size` setting. For more details, see [Connection pooling](https://neon.com/docs/connect/connection-pooling).

## Pooler server connections

![Pooler server connections graph](https://neon.com/docs/introduction/pooler_server_connections.png)

The **Pooler server connections** graph shows connections from Neon's PgBouncer pooler to your Postgres database. This graph only displays data when you're using a [pooled connection string](https://neon.com/docs/connect/connection-pooling) (one that includes `-pooler` in the endpoint hostname).
...
![Monitoring page database size graph](https://neon.com/docs/introduction/monitor_data_size.png)
...
![Monitoring page deadlocks graph](https://neon.com/docs/introduction/monitor_deadlocks.png)
...
![Monitoring page rows graph](https://neon.com/docs/introduction/monitor_rows.png)
...
![local file cache hit rate graph](https://neon.com/docs/introduction/local_file_cache_hit_rate.png)
...
![working set size graph](https://neon.com/docs/introduction/working_set_size.png)

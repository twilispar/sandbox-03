...
For more information, see [Neon CLI commands — set-context](https://neon.com/docs/reference/cli-set-context).
...
The backend for apps and agents. Includes Neon Postgres, Neon Auth, and Data API today, with Storage, Compute, and AI Gateway coming soon. Neon Postgres is serverless, with autoscaling, branching, instant restore, and scale-to-zero. For more information, see [Why Neon?](https://neon.com/docs/introduction).

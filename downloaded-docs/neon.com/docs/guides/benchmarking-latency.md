> This page location: Connect to Neon > Latency benchmarks
...
![Screenshot of Neon's latency benchmarks dashboard showing regional performance metrics](https://neon.com/docs/guides/latency_benchmark.png)

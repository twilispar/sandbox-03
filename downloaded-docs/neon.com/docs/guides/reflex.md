> This page location: Frontend & Frameworks > Frameworks > Reflex
...
Pre-built prompt for connecting Reflex applications to Neon Postgres [View prompt](https://neon.com/prompts/reflex-prompt.md)
...
![Reflex Customer Data App](https://neon.com/docs/guides/reflex_customer_data_app.png)

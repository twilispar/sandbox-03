> This page location: Frontend & Frameworks > Languages > .NET
...
Learn how to run SQL queries in Neon from .NET using the Npgsql library

Pre-built prompt for connecting .NET applications to Neon [View prompt](https://neon.com/prompts/dotnet-prompt.md)
...
3. Select **.NET** as your connection method.
   ![Connection modal](https://neon.com/docs/connect/dotnet_connection_details.png)

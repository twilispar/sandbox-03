> This page location: Frontend & Frameworks > Frameworks > Micronaut Kotlin
...
Pre-built prompt for connecting Micronaut Kotlin applications to Neon Postgres [View prompt](https://neon.com/prompts/micronaut-kotlin-prompt.md)

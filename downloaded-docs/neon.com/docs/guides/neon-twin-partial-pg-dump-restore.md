> This page location: Tools & Workflows > Workflows & CI/CD > Neon Twin > pg_dump / pg_restore — Partial Twin
...
# pg_dump / pg_restore — Partial Twin
...
**Important:** Avoid using `pg_dump` over a [pooled connection string](https://neon.com/docs/reference/glossary#pooled-connection-string). Use an [unpooled connection string](https://neon.com/docs/reference/glossary#unpooled-connection-string) for `PROD_DATABASE_URL` and `DEV_DATABASE_URL` when they point to Neon.
...
![GitHub repository secrets](https://neon.com/docs/guides/twin_diagram_github_secrets.png)
...
![GitHub Actions run workflow](https://neon.com/docs/guides/twin_diagram_test_workflow.png)
...
## Related docs (Neon Twin)

- [pg_dump / pg_restore — Full Twin](https://neon.com/docs/guides/neon-twin-full-pg-dump-restore)

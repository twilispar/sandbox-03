> This page location: Frontend & Frameworks > Frameworks > Encore
...
![Encore local development dashboard](https://neon.com/guides/images/neon-encore-dashboard.png)
...
1. **Create a Neon API Key.**
   ...
   - Create a new API key and copy it. See [Manage API keys](https://neon.com/docs/manage/api-keys) for more information.
...
- [Get started with Encore and Neon](https://github.com/neondatabase/examples/tree/main/with-encore): Encore.ts application with Neon Postgres

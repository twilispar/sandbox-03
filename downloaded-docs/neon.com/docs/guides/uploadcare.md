> This page location: Tools & Workflows > Integrations (3rd party) > File & media storage > Uploadcare
...
4. Note your **Public Key** and **Secret Key**. They are needed to interact with the Uploadcare API and widgets.
   ![Uploadcare API Keys](https://neon.com/docs/guides/uploadcare-api-keys.png)
...
If you use [Neon's Row Level Security (RLS)](https://neon.com/blog/introducing-neon-authorize), remember to apply appropriate access policies to the `uploadcare_files` table. This controls who can view or modify the object references stored in Neon based on your RLS rules.

> This page location: Tools & Workflows > Integrations (3rd party) > Serverless > Trigger serverless functions with Inngest
...
![trigger serverless functions with inngest](https://neon.com/docs/guides/inngest.jpg)
...
![Neon integration card inside the Inngest integrations page](https://neon.com/docs/guides/inngest-integrations-page.png)
...
![Neon authorization step inside the Inngest integrations page](https://neon.com/docs/guides/inngest-integration-neon-authorize-step.png)
...
![You can add a new record to the users table directly from the Neon console](https://neon.com/docs/guides/inngest-integration-neon-console-users-table-add-new-record.png)
...
![The Inngest Platform lists all the runs](https://neon.com/docs/guides/inngest-integrations-inngest-platform-new-runs.png)

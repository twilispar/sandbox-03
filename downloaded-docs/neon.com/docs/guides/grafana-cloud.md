> This page location: Neon platform > Monitoring & observability > Third-party monitoring > Grafana Cloud
...
**Tip:** The wizard automatically generates a token with the correct permissions (metrics:write, logs:write, traces:write).

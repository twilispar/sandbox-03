> This page location: Read replicas > Create and manage
...
Learn how to create and manage read replicas in Neon
...
![View read replicas](https://neon.com/docs/guides/view_read_replica.png)
...
- [Overview](https://neon.com/docs/introduction/read-replicas)

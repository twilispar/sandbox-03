> This page location: Data protection > Private Networking
...
**Coming Soon: Private Networking availability**

Private Networking is available on Neon's [Scale](https://neon.com/docs/introduction/plans#scale) plan. If you're on a different plan, you can request a trial from the **Network Security** page in your project's settings.
...
![Neon Private Networking diagram](https://neon.com/docs/guides/neon_private_access.jpg)
...
1. Go to the AWS **VPC > Endpoints** dashboard and select **Create endpoint**. Make sure you create the endpoint in the same VPC as your client application.
   ...
   ![VPC Dashboard](https://neon.com/docs/guides/pl_vpc_dashboard.png)

2. Optionally, enter a **Name tag** for the endpoint (for example, `My Neon Private Networking`).

3. For **Type**, select the **Endpoint services that use NLBs and GWLBs** category.

   ![VPC Create endpoint](https://neon.com/docs/guides/pl_vpc_create_endpoint.png)
...
5. Click **Verify service**. If successful, you should see a `Service name verified` message.
   ...
   ![VPC Create endpoint](https://neon.com/docs/guides/pl_vpc_service_name_verified.png)
...
8. Click **Create endpoint** to complete the setup of the endpoint service.
   ...
   ![VPC Create endpoint](https://neon.com/docs/guides/pl_vpc_network_settings.png)

9. Note your **VPC Endpoint ID**. You will need it in the next step.

   ![VPC Create endpoint](https://neon.com/docs/guides/pl_vpc_endpoint_id.png)
...
4. Save your changes.
   ![Enable private DNS](https://neon.com/docs/guides/pl_enable_private_dns.png)

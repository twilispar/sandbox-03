> This page location: Frontend & Frameworks > ORMs > Tortoise ORM
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: How to connect an asynchronous Python application to a Neon project using Tortoise ORM, the asyncpg driver.

# Connect a Tortoise ORM application to Neon

Set up a Neon project in seconds and connect from a Python async application

Pre-built prompt for connecting Tortoise ORM applications to Neon Postgres [View prompt](https://neon.com/prompts/tortoise-orm-prompt.md)
...
![Connection details modal](https://neon.com/docs/connect/connection_details_parameters_only.png)

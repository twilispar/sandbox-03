> This page location: Logical replication > Concepts
...
![Logical replication publisher subscriber architecture](https://neon.com/docs/guides/logical_replication_model.jpg)
...
You can enable logical replication from the Neon Console or via the API. See [Enable logical replication](https://neon.com/docs/guides/logical-replication-neon#enable-logical-replication) for instructions.
...
**Important:** To prevent storage bloat, **Neon automatically removes _inactive_ replication slots after a period of time. Please see [Unused replication slots](https://neon.com/docs/guides/logical-replication-neon#unused-replication-slots) to learn more.
...
- [Getting started](https://neon.com/docs/guides/logical-replication-guide)

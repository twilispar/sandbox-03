> This page location: OAuth integration
...
**Note:** We only provide OAuth integrations for partners we have active commercial relationships with. If you already partner with Neon, the information below documents our OAuth integration. Reach out to your Neon point of contact if you have any questions.

## How the OAuth integration works

Here is a high-level overview of how Neon's OAuth implementation works:

![OAuth flow diagram](https://neon.com/docs/oauth/flow.png)
...
![Neon OAuth consent screen](https://neon.com/docs/oauth/consent.png)
...
* [View live demo](https://neon-experimental.vercel.app): Try the live demo application
* [View on GitHub](https://github.com/neondatabase/neon-branches-visualizer): Explore the source code and implementation

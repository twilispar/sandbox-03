> This page location: Neon platform > Monitoring & observability > Third-party monitoring > OpenTelemetry
...
Send Neon metrics and Postgres logs to any OTEL-compatible observability platform
...
- **Grafana** at [http://localhost:3000](http://localhost:3000) (admin/admin)
- **OpenTelemetry Collector** at [http://localhost:4318](http://localhost:4318) (HTTP) and localhost:4317 (gRPC)
...
2. Once signed in, you'll need your New Relic license key for authentication.
   ...
   **Tip:** If you get stuck in New Relic's onboarding screens and don't see a way to proceed, try opening the Logs or Data Explorer pages in a new browser tab. This can sometimes let you access the main New Relic UI and continue with your setup.
   ...
   ![New Relic profile menu showing API Keys option](https://neon.com/docs/guides/new_relic_api_keys.png) 3. Click **Create a key** → choose **Ingest - License**. Copy the key immediately (you can't view it again later).

   ![New Relic API Keys page showing license key types](https://neon.com/docs/guides/new_relic_copy_key.png)
...
2. Locate the **OpenTelemetry** card and click **Add**.
   ...
   ![open telemetry integration card](https://neon.com/docs/guides/open_telemetry_card.png)

   The sidebar form opens for you to enter your platform's details.

   ![OpenTelemetry integration configuration form](https://neon.com/docs/guides/opentelemetry_config_form.png)
...
**Tip:** You can edit your integration settings at any time from the **Integrations** page in the Neon Console. This allows you to update your endpoint URL, change authentication credentials, or modify resource attributes without having to delete and recreate the integration.
...
![Neon metrics appearing in New Relic](https://neon.com/docs/guides/new_relic_metrics_success.png)

_Postgres logs flowing into New Relic_
![Neon PostgreSQL logs appearing in New Relic](https://neon.com/docs/guides/new_relic_logs_success.png)

**Find your data under APM & Services**
![Multiple Neon services in New Relic APM & Services](https://neon.com/docs/guides/new_relic_services.png)

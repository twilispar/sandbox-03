> This page location: Backend > Data API > Guides > Secure your app with RLS
...
Learn how Row-level Security (RLS) protects user data
...
- **Neon Data API + Neon Auth example application**: Clone the sample [Neon Data API + Neon Auth repository](https://github.com/neondatabase-labs/neon-data-api-neon-auth):
  ...
  > This sample app uses Neon Auth, so select **Neon Auth** when enabling the Data API. If you're using a different auth provider, see [Custom authentication providers](https://neon.com/docs/data-api/custom-authentication-providers).
...
![empty state two users in data api demo](https://neon.com/docs/guides/data_api_demo_empty_state.png)
...
![isolated note lists](https://neon.com/docs/guides/data_api_demo_isolated_notes.png)

The paragraphs in the notes are:

![paragraphs in notes](https://neon.com/docs/guides/data_api_demo_paragraphs_in_notes.png)
...
![isolated notes](https://neon.com/docs/guides/data_api_demo_isolated_notes.png)
...
![data leak](https://neon.com/docs/guides/data_api_demo_data_leak.png)
...
![isolated notes restored](https://neon.com/docs/guides/data_api_demo_isolated_notes.png)
...
To get an understanding of `auth.user_id()` and the role it plays in these policies, see this [explanation](https://neon.com/docs/data-api/get-started#what-is-authuserid-and-authuid).

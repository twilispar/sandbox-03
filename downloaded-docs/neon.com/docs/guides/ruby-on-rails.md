> This page location: Frontend & Frameworks > ORMs > Ruby on Rails (ActiveRecord)
...
Pre-built prompt for connecting Ruby on Rails to Neon Postgres [View prompt](https://neon.com/prompts/ruby-on-rails-prompt.md)

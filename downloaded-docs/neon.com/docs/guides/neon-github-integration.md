> This page location: Tools & Workflows > Integrations (3rd party) > Develop > GitHub integration
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Covers the setup of the Neon GitHub integration, enabling connection between a Neon Postgres project and a GitHub repository for database development and automated workflows using GitHub Actions.
...
2. Locate the **GitHub** card and click **Add**.
   ![GitHub App card](https://neon.com/docs/guides/github_card.png)
...
## Related docs (Develop)

- [Convex](https://neon.com/docs/https://neon.com/guides/convex-neon)

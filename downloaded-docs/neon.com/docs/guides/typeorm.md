> This page location: Frontend & Frameworks > ORMs > TypeORM
...
Pre-built prompt for connecting Node.js applications to Neon using TypeORM. [View prompt](https://neon.com/prompts/typeorm-prompt.md)

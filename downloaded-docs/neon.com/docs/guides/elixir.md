> This page location: Frontend & Frameworks > Languages > Elixir
...
Learn how to run SQL queries in Neon from Elixir using Postgrex

Pre-built prompt for connecting Elixir applications to Neon [View prompt](https://neon.com/prompts/elixir-prompt.md)
...
3. Select the **Parameters only** tab to view the connection string parameters.
   ![Connection modal](https://neon.com/docs/connect/connection_details_parameters_only.png)

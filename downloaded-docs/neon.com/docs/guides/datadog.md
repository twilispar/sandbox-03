> This page location: Neon platform > Monitoring & observability > Third-party monitoring > Datadog
...
3. Enter your **Datadog API key**. You can generate or retrieve [Datadog API Keys](https://app.datadoghq.com/organization-settings/api-keys) from your Datadog organization. For instructions, see [Datadog API and Application Keys](https://docs.datadoghq.com/account_management/api-app-keys/).
...
![neon dashboard in datadog](https://neon.com/docs/guides/neon-dashboard-datadog.png)
...
![select endpoint variable in dashboard](https://neon.com/docs/guides/datadog_select_endpoint.png)
...
Neon exports a comprehensive set of metrics including connection counts, database size, replication delay, compute metrics (CPU and memory usage), and PgBouncer connection pooling metrics (client and server connections). For a complete list of all available metrics with detailed descriptions, see the [Metrics and logs reference](https://neon.com/docs/reference/metrics-logs).

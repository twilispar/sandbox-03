> This page location: Tools & Workflows > Workflows & CI/CD > Neon Twin > pg_dump / pg_restore — Full Twin
...
- [pg_dump / pg_restore — Partial Twin](https://neon.com/docs/guides/neon-twin-partial-pg-dump-restore)

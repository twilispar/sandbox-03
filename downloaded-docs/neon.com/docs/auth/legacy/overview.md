> This page location: Backend > Neon Auth > Legacy (archive) > Stack Auth > Introduction
...
# Legacy Neon Auth with Stack Auth

For existing users only (not available for new projects)

**Warning: You are viewing legacy documentation**
...
**For the new Neon Auth built with Better Auth**, see [Neon Auth documentation](https://neon.com/docs/auth/overview). Ready to upgrade? See our [migration guide](https://neon.com/docs/auth/migrate/from-legacy-auth).
...
![Users in Neon Auth](https://neon.com/docs/guides/identity_users.png)
...
| ----------- | ------------- | --------------------------------------------- | ------------------- | ------------------- | ----------- | -------------------------------- |
| d37b6a30... | Jordan Rivera | [jordan@company.co](mailto:jordan@company.co) | 2025-05-09 16:15:00 | null                | null        | `{\"id\": \"d37b6a30...\", ...}` |
| 51e491df... | Sam Patel     | [sam@startup.dev](mailto:sam@startup.dev)     | 2025-02-27 18:36:00 | 2025-02-27 18:36:00 | null        | `{\"id\": \"51e491df...\", ...}` |
...
For detailed integration patterns, foreign key examples, and best practices, see [Database Integration](https://neon.com/docs/auth/legacy/database-integration).
...
You can also find your current project ID here, as well as the JWKS URL you need to set up [RLS in your Neon Auth project](https://neon.com/docs/auth/legacy/database-integration#row-level-security-rls).
...
Ready to upgrade to Neon Auth with Better Auth? See our comprehensive [migration guide](https://neon.com/docs/auth/migrate/from-legacy-auth).
...
[View Migration Guide →](https://neon.com/docs/auth/migrate/from-legacy-auth)
...
- [Database Integration](https://neon.com/docs/auth/legacy/database-integration) - Technical reference for `users_sync`, backend auth, RLS
- [Migration Guide](https://neon.com/docs/auth/migrate/from-legacy-auth) - Upgrade to Neon Auth with Better Auth
- [Neon Auth](https://neon.com/docs/auth/overview) - Current Neon Auth with Better Auth

---

## Related docs (Stack Auth)

- [Database integration](https://neon.com/docs/auth/legacy/database-integration)

> This page location: Backend > Neon Auth > Legacy (archive) > Stack Auth > Database integration
> Full Neon documentation index: https://neon.com/docs/llms.txt

> Summary: Covers how to use the `neon_auth.users_sync` table for user data synchronization, authenticate backend requests, and implement Row-Level Security (RLS) within the Legacy Neon Auth framework.

# Legacy Neon Auth - Database Integration

Technical reference for users_sync table, backend auth, and RLS
...
2. Copy the **JWKS URL** shown in the **Claim project** section.
   ...
   ![jwks in claim project section](https://neon.com/docs/changelog/neon_auth_jwks.png)
...
- [Secure your app with RLS](https://neon.com/docs/guides/rls-tutorial) - Tutorial walkthrough
- [Simplify RLS with Drizzle](https://neon.com/docs/guides/rls-drizzle) - Using Drizzle ORM with RLS
...
- [Legacy Overview](https://neon.com/docs/auth/legacy/overview) - What is Legacy Neon Auth, claiming projects, environment variables
...
- [Secure your app with RLS](https://neon.com/docs/guides/rls-tutorial) - RLS tutorial
- [Simplify RLS with Drizzle](https://neon.com/docs/guides/rls-drizzle) - RLS with Drizzle ORM
...
- [Introduction](https://neon.com/docs/auth/legacy/overview)
